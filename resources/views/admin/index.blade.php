...
<head>
    ...
    <script src="/houtai/assets/js/echarts.min.js"></script>
</head>
...
<body data-type="index">
    ...
    <header class="am-topbar am-topbar-inverse admin-header">
        <div class="am-topbar-brand">
            <a href="javascript:;" class="tpl-logo">
                <img src="/houtai/assets/img/logo.jpg" alt="">
            </a>
        </div>
            ...
            <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    ...
                    <ul class="am-dropdown-content tpl-dropdown-content">
                      ...
                      <img src="/houtai//houtai/assets/img/user02.png" alt=""> </span>
                      ...
                      <span class="tpl-dropdown-content-from"> 禁言小张 </span>
                            ...
                            <a href="#" class="tpl-dropdown-content-message">
                                <span class="tpl-dropdown-content-photo">
                      <img src="/houtai//houtai/assets/img/user03.png" alt=""> </span>
                                <span class="tpl-dropdown-content-subject">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    <a class="am-dropdown-toggle tpl-header-list-link" href="javascript:;">
                        <span class="tpl-header-list-user-nick">禁言小张</span><span class="tpl-header-list-user-ico"> <img src="/houtai/assets/img/user01.png"></span>
                    </a>
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            @if(session('msg'))
            <div class="tpl-content-page-title" style="float: right;">
                {{session('msg')}}
            </div>
            @endif
                        ...
                        <div class="tpl-scrollable">
                            ...
                            <table class="am-table tpl-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="/houtai/assets/img/user01.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="/houtai/assets/img/user02.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="/houtai/assets/img/user03.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="/houtai/assets/img/user04.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="/houtai/assets/img/user05.png" alt="" class="user-pic">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="/houtai/assets/img/user06.png" alt="" class="user-pic">
    ...
    <script src="/houtai/assets/js/iscroll.js"></script>
